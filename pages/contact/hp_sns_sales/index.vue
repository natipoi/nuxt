    ...
    <section class="section">
      <div class="inner-section">
        ...
        <div class="heading-title">
            <h1>お問い合わせ<span>ホームページ・SNS 運用改善</span></h1>
        </div>

        <form id="form" action="/email/" method="POST">
        <input type="hidden" name="type" value="ホームページ・SNS 運用改善" id="type-input">
        <input type="hidden" name="color" value="#999038" id="color-input">
        <div class="form-box">
...
export default {
    ...
    head () {
        return {
            ...
            meta: [
                { hid: 'og:title', property: 'og:title', content: "ホームページ・SNS 運用改善に関するお問い合わせ｜Fitpoi" },
